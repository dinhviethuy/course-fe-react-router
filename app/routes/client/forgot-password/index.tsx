import type { Route } from '.react-router/types/app/routes/client/forgot-password/+types'
...
export function meta({}: Route.MetaArgs) {
  return [{ title: 'Quên mật khẩu' }, { name: 'description', content: 'Quên mật khẩu' }]
}
  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className='flex flex-col gap-2'>
        ...
        <p className='text-center text-sm text-muted-foreground'>Nhập địa chỉ email của bạn để lấy lại mật khẩu</p>
      </div>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <div className='relative'>
              ...
              {!shownConfirmNewPassword ? (
                <EyeIcon
                  className='absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 cursor-pointer'
                  onClick={() => setShownConfirmNewPassword(!shownConfirmNewPassword)}
                />
              ) : (
                <EyeOffIcon
                  className='absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 cursor-pointer'
