import type { Route } from '.react-router/types/app/routes/client/register/+types'
  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className='flex flex-col gap-2'>
        ...
        <p className='text-center text-sm text-muted-foreground'>Tài khoản này sẽ dùng để mua khóa học, học tập</p>
      </div>
      <div className='flex flex-col gap-8 p-4'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex items-center justify-center gap-1'>
            <span className='text-center text-sm text-muted-foreground'>Bạn quên mật khẩu?</span>
